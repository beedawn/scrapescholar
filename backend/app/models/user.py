...
from sqlalchemy import Column, Integer, String, ForeignKey, DateTime  # Import DateTime
from sqlalchemy.orm import relationship
from datetime import datetime  # Import datetime for utcnow function
...
class User(Base):
    ...
    article_scores = relationship("ArticleScore", back_populates="user")
