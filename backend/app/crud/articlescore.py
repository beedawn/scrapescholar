...
def get_article_score(db: Session, article_score_id: int):
    return db.query(ArticleScore).filter(ArticleScore.article_score_id == article_score_id).first()
...
def delete_article_score(db: Session, article_score_id: int):
    db_article_score = db.query(ArticleScore).filter
    (ArticleScore.article_score_id == article_score_id).first()
    if db_article_score:
