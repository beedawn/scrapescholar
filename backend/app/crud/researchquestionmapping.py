...
def get_research_question_mapping(db: Session, research_question_mapping_id: int):
    mapping = db.query(ResearchQuestionMapping).filter(
        ResearchQuestionMapping.research_question_mapping_id == research_question_mapping_id).first()
    if not mapping:
...
def update_research_question_mapping(db: Session, research_question_mapping_id: int,
                                     research_question_mapping: ResearchQuestionMappingUpdate):
    db_research_question_mapping = db.query(ResearchQuestionMapping).filter(
        ResearchQuestionMapping.research_question_mapping_id == research_question_mapping_id).first()
