...
from app.crud.search import delete_search
...
def test_get_search_shares(test_db_session: Session):
    ...
    search_share_data_list = [
        generate_unique_share_data(search_id=new_search.search_id, shared_with_user_id=new_user.user_id,
                                   shared_by_user_id=test_user.user_id),
        generate_unique_share_data(search_id=new_search_2.search_id, shared_with_user_id=new_user.user_id,
                                   shared_by_user_id=test_user.user_id),
        generate_unique_share_data(search_id=new_search_3.search_id, shared_with_user_id=new_user.user_id,
                                   shared_by_user_id=test_user.user_id)
    ]
    shares = []
